...
TensorFlow: [GitHub Repository](https://github.com/tensorflow/tensorflow) PyTorch: [GitHub Repository](https://github.com/pytorch/pytorch)&nbsp;&nbsp;&nbsp;scikit-learn: [GitHub Repository](https://github.com/scikit-learn/scikit-learn)&nbsp;&nbsp;&nbsp;Keras: [GitHub Repository](https://github.com/keras-team/keras)&nbsp;&nbsp;&nbsp;XGBoost: [GitHub Repository](https://github.com/dmlc/xgboost)&nbsp;&nbsp;&nbsp;LightGBM: [GitHub Repository](https://github.com/microsoft/LightGBM)
